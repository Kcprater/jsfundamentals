...
//             (7)  (8)
let person4 = new Person('Kris', 34, true);
...
/*  
    ...
    3. the parameters. these will be the value for the keys in our object once a new "Person" is created
    ...
    6. the arguement we pass through our function cal will resolved as the values
